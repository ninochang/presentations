...
## cli deploy new run 
`gcloud run deploy kserving-helloworld-python --image asia.gcr.io/swag-nino-chang/kserving-helloworld-python  --no-traffic --tag staging --set-env-vars=TARGET="Python Sample v3"`
